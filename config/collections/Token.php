...
return array(
    ...
    'schema' => array(
        ...
        'secret_key'  => String::create('secret_key')->filter('trim|required')->set('list-column', true)->set('generated', true),
        'shared_key'  => String::create('shared_key')->filter('trim|required')->set('list-column', true)->set('generated', true),
    ),
);
